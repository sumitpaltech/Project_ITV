...
<div class="d-flex justify-content-center align-items-center" style="min-height: 90vh;">
    <div class="card shadow-sm" style="width: 420px;">
        <div class="card-body p-4">
            <h4 class="fw-bold mb-1"><i class="bi bi-check2-square me-2 text-primary"></i>TaskApp</h4>
            <p class="text-muted mb-4">Create a new user account</p>
            ...
            <form action="{{ route('auth.register') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <select name="department" class="form-select" required>
                        ...
                        @foreach(config('departments.list') as $dept)
            ...
            <p class="text-center text-muted mb-0">
                <a href="{{ route('dashboard.users') }}" class="fw-semibold">Back to user list</a>
            </p>
        </div>
    </div>
</div>
